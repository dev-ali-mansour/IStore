//package com.example.istore.auth.ui.login
//
...
//
//                    //redirect the user to the fragment_login screen
//                    redirectLoginScreen()
//                }
//                if (!task.isSuccessful) {
//                    Toast.makeText(
...
//
//    /**
//     * Redirects the user to the fragment_login screen
//     */
//    private fun redirectLoginScreen() {
//        Log.d(TAG, "redirectLoginScreen: redirecting to fragment_login screen.")
